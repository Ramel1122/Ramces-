...
<head>
    ...
    <!-- Bootstrap + Ramces main styles -->
	<link rel="stylesheet" href="assets/css/Ramces.css">
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title">Ramces Labrador</h1>
                <h6 class="header-mono" >UX /IT PROGRAMMER WEB Developer</h6>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    ...
                    <li class="brand-txt">
                        <h5 class="brand-title">Ramces Labrador</h5>
                        <div class="brand-subtitle">UX Designer | IT Program Web Developer</div>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="#blog" class="nav-link">Personal Blog</a>
                    </li>
                    <li class="nav-item last-item">
                        <a href="#contact" class="nav-link">Contact number</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">A IT Programmer / UX Designer Located In Our Lovely Earth</h5>
                <p class="mt-20">I'm an IT programmer and UX designer, passionate about creating user-friendly interfaces and efficient code to enhance digital experiences.</p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 05/15/2002</li>
                    <li><span>Email</span> : Ramces@website.com</li>
                    <li><span>Phone</span> : + (123) 9386751218</li>
                    <li><span>Skype</span> : Ramces </li>
                    <li><span>Address</span> :  Langkaan 1 pamela homes.</li>
                </ul>
                <ul class="social-icons pt-3">
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>UX Design</h6>
                        <p class="subtitle"> User-centered, Intuitive,Prototyping ,Research,Interaction.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>IT PROGRAMMER</h6>
                        <p class="subtitle">Coding,Debugging, Algorithms,Automation,Problem-solving.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Web Developer</h6>
                        <p class="subtitle">HTML,CSS,JavaScript,Responsive,Deployment</p>
                        <hr>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            <h6 class="title text-danger"></h6>
                            <P>UX Developer</P>
                            <P class="subtitle">I integrate user research findings into functional designs for applications.    .</P>
                            <hr>
                            <h6 class="title text-danger">2026 - 2027</h6>
                            <P>Front-end Developer</P>
                            <P class="subtitle">I craft interactive interfaces using HTML, CSS, and JavaScript technologies!.</P>
                            <hr>
                            <h6 class="title text-danger">2024 - 2024</h6>
                            <P>UX Designer</P>
                            <P class="subtitle">I focus on enhancing user satisfaction through improved usability and accessibility!.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P class="subtitle">Degree focusing on computer systems, software development, and information technology principles..</P>
                            <hr>
                            <h6 class="title text-danger">2016 - 2017</h6>
                            <P>Diploma in senior high school </P> 
                            <P class="subtitle"> Completion certificate encompassing general education requirements for further academic or vocational pursuits.  !.</P>
                            <hr>
                            <h6 class="title text-danger">2015 - 2016</h6>
                            <P>High School Degree</P>
                            <P class="subtitle">Credential awarded after completing secondary education, signifying foundational knowledge and skills development. !.</P>
    ...
    <section class="section bg-danger text-center">
        <div class="container">
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+ (123) 0985265521</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
